...
type DepStore interface {
	...
	SyncRepoDependencies(ctx context.Context, repoID uuid.UUID, deps []npm.ParsedDep) error
...
func (s *Store) SyncRepoDependencies(ctx context.Context, repoID uuid.UUID, deps []npm.ParsedDep) error {
