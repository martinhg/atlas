...
func TestComputeRiskScore(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			repos: []Affected{
				{DepType: "dev", Teams: []string{"@acme/team-x"}},
			},
			wantLevel: RiskLow,
		},
		{
			...
			wantLevel: RiskHigh,
			repos: []Affected{
				{DepType: "direct", Teams: []string{"@acme/team-1"}},
				{DepType: "direct", Teams: []string{"@acme/team-2"}},
				{DepType: "direct", Teams: []string{"@acme/team-3"}},
				{DepType: "direct", Teams: []string{"@acme/team-4"}},
				{DepType: "direct", Teams: []string{"@acme/team-5"}},
				{DepType: "direct", Teams: []string{"@acme/team-1"}},
				{DepType: "direct", Teams: []string{"@acme/team-2"}},
				{DepType: "direct", Teams: []string{"@acme/team-3"}},
				{DepType: "direct", Teams: []string{"@acme/team-4"}},
...
func TestComputeRiskScore_boundaryValues(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			repos: []Affected{
				{DepType: "direct", Teams: []string{"@acme/team-x"}},
				{DepType: "direct", Teams: []string{"@acme/team-x"}},
			},
			wantLevel: RiskLow,
		},
		{
			...
			repos: []Affected{
				{DepType: "direct", Teams: []string{"@acme/team-x"}},
				{DepType: "direct", Teams: []string{"@acme/team-y"}},
				{DepType: "direct", Teams: []string{"@acme/team-z"}},
			},
		...
		},
		{
			...
			repos: []Affected{
				{DepType: "optional", Teams: []string{"@acme/team-x"}},
				{DepType: "optional", Teams: []string{"@acme/team-y"}},
				{DepType: "optional", Teams: []string{"@acme/team-z"}},
			},
			wantLevel: RiskLow,
		},
	}
